        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <img
                src="/videos/testimonials/another-testimonial.jpg"
              ...
              <div className="p-6 bg-white">
                ...
                <p className="text-gray-700 font-semibold mb-2">Studio Photo Testimonial</p>
                <p className="text-sm text-gray-600">Professional patient testimonial showcasing our clinic quality</p>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <img
                src="/videos/testimonials/gusta-testimonial.jpg"
                alt="Patient Testimonial - Gusta"
                className="w-full h-64 object-cover"
              />
              <div className="p-6 bg-white">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-gray-600">Satisfied patient sharing their positive experience</p>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <img
                src="/videos/testimonials/shyam-testimonial.jpg"
                alt="Patient Testimonial - Shyam"
                className="w-full h-64 object-cover"
              />
              <div className="p-6 bg-white">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-gray-600">Happy patient testimonial from our clinic</p>
              </div>
            </div>
          </div>
        </div>
